...
class SurgicalVideoDataset(Dataset):
    ...
    def __init__(self,
        ...
        print(f"  Cache clips: {cache_clips}")
    ...
    def __len__(self):
        ...
        paper1231 style: Returns total number of clips across all videos,
        not number of videos. Each clip is an independent training sample.
        """
        if self.cache_clips and self.clips is not None:
            return len(self.clips)
        else:
            # Fallback to video count if clips not cached
